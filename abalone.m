...
Ac = A;
%% Graphing Data with testing data
% figure()
% for x = 1:1:n_ex
% t = A(x,class);
% 
...
% end
% 
% scatter3(A(x,att1),A(x,att2),A(x,att3),sz,d, c);
% axis([0 1 0 1 0 1]);
% hold on
% end
% 
...
% end
% 
% scatter3(test_data(x,att1),test_data(x,att2),test_data(x,att3),sz,d, c);
% hold on
% end
